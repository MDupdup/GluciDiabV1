...
public class AccompagnementsAdapter {
    private Context kContext;

    public AccompagnementsAdapter(Context c) {
        kContext = c;
    }

    public int getCount() {
        return kAccompagnementsIds.length;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView.setImageResource(kAccompagnementsIds[position]);
        return imageView;
    }

    private Integer[] kAccompagnementsIds = {
            R.drawable.kfctomatescerises,
