...
public class SaladesAdapter {
    private Context kContext;

    public SaladesAdapter(Context c) {
        kContext = c;
    }

    public int getCount() {
        return kSaladesIds.length;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView.setImageResource(kSaladesIds[position]);
        return imageView;
    }

    private Integer[] kSaladesIds = {
