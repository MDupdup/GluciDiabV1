...
public class PiecesPouletAdapter {
    private Context kContext;

    public PiecesPouletAdapter(Context c) {
        kContext = c;
    }

    public int getCount() {
        return kPiecesPouletIds.length;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView.setImageResource(kPiecesPouletIds[position]);
        return imageView;
    }

    private Integer[] kPiecesPouletIds = {
